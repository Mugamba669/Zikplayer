...
class PureKnob {
		 ...
		 */
		constructor() {
		this.createBarGraph = function(width = 0, height = 0) {
		...
		this.createKnob = function(width, height) {
			...
			// canvas.addEventListener('input', mouseMoveListener);
			canvas.addEventListener('mouseup', mouseUpListener);
			canvas.addEventListener('resize', resizeListener);
			canvas.addEventListener('touchstart', touchStartListener);
			// canvas.addEventListener('input', touchMoveListener);
			...
			// canvas.addEventListener('input', scrollListener);
			input.addEventListener('keydown', keyDownListener);
			return knob;
		};
	}
}
	module.exports =  PureKnob;
